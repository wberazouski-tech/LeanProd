...
export type TechnologyStageLinkType = 'FinishToStart' | 'StartToStart' | 'FinishToFinish' | 'StartToFinish';
...
export interface CatalogTechnologyDetails extends CatalogTechnologySummary { description: string | null; stages: CatalogTechnologyStage[]; stageLinks: CatalogTechnologyStageLink[]; rowVersion: string; }
export interface CatalogTechnologyStage { id: string; stageTemplateId: string | null; stageTemplateName: string | null; code: string; name: string; lineNo: number; plannedDurationMinutes: number | null; departmentId: string | null; departmentName: string | null; equipmentId: string | null; equipmentName: string | null; description: string | null; materials: CatalogTechnologyMaterial[]; outputs: CatalogTechnologyStageOutput[]; operations: CatalogTechnologyOperation[]; }
export interface CatalogTechnologyStageLink { id: string; fromStageId: string; toStageId: string; linkType: TechnologyStageLinkType; lagMinutes: number; }
