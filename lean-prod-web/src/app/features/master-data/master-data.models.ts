...
export interface DepartmentDetails { id: string; code: string; name: string; description: string | null; parentDepartmentId: string | null; workScheduleId: string | null; isActive: boolean; rowVersion: string; }
...
export interface CatalogTechnologyStageOutput { id: string; catalogItemId: string; catalogItemName: string; unitOfMeasureId: string; unitOfMeasureName: string; quantity: number; receiptStorageLocationId: string; receiptStorageLocationName: string; isPrimary: boolean; note: string | null; rowVersion: string; }
export interface CatalogTechnologyOperation { id: string; code: string; name: string; departmentId: string | null; departmentName: string | null; equipmentId: string | null; equipmentName: string | null; setupMinutes: number; runMinutes: number; laborMinutes: number; workers: number; note: string | null; rowVersion: string; }
export interface CatalogTechnologyMaterialSupplyRouteStep { id: string; lineNo: number; fromStorageLocationId: string; fromStorageLocationName: string; toStorageLocationId: string | null; toStorageLocationName: string | null; isConsumptionPoint: boolean; movementKind: TechnologyMaterialMovementKind; leadTimeMinutes: number; note: string | null; rowVersion: string; }
