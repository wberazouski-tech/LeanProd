...
{
    /// <inheritdoc />
    public partial class InternalInitialCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredLanguage = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false, defaultValue: "be"),
                    DefaultDepartmentId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TradingName = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    ...
                    DefaultCurrencyCode = table.Column<string>(type: "TEXT", fixedLength: true, maxLength: 3, nullable: false),
                    TimeZoneId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    DefaultLanguageCode = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternalOrganization", x => x.Id);
                    table.CheckConstraint("CK_InternalOrganization_Singleton", "`Id` = 1");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationSettings_UpdatedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternalOrganization_InstallationId",
